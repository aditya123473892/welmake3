...
import { Bubble } from "../FrothEffect/Bubble";

function HeroSection3dr7() {
  ...
  const addBubble = (x, y) => {
    ...
    bubbles.current.push(new Bubble(x, y, radius));
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      ctx.fillStyle = "#77B254"; // Apply the green background color
  ...
  return (
    <div className="relative bg-[#77B254] overflow-hidden min-h-[90vh]">
      {/* Canvas for bubbles */}
      <canvas
        ref={canvasRef}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="overflow-hidden">
              ...
              >
                ...
                <br />
                <motion.span
                  className="text-white inline-block mb-5 mt-1"
                  initial={{ y: 100 }}
                  animate={{ y: 0 }}
                  transition={{
                    duration: 1,
            ...
            <motion.p
              className="text-2xl text-[#FFE8B6] max-w-xl font-baloo font-semibold leading-relaxed"
            ...
            >
              Dr.7 Dish Wash Bar delivers spotless, grease-free dishes while
              being gentle on hands. Its powerful formula removes tough stains
              effortlessly, yet stays skin-friendly. With eco-friendly
              ingredients and a refreshing fragrance, it ensures a safe,
              sustainable clean every time.
            </motion.p>
            ...
            >
              <motion.button
                className="bg-[#005486] text-white px-12 py-6 rounded-full text-xl font-semibold flex items-center justify-center gap-3 hover:shadow-xl transition-all group overflow-hidden relative"
                whileHover={{
                  scale: 1.03,
                  boxShadow:
              ...
              >
                <motion.span
                  className="absolute inset-0 bg-[#005486] z-0"
                  initial={{ x: "-100%" }}
                  whileHover={{ x: 0 }}
          ...
          >
            <div className="relative aspect-square">
              <motion.div
                className="absolute inset-0 bg-[#77B254] rounded-full"
                animate={{
                  scale: [1, 1.02, 1],
                }}
                transition={{
...
export default HeroSection3dr7;
