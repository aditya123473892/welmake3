...
import slide1 from "../assets/2x.png";
import slide2 from "../assets/sf.png";
import slide3 from "../assets/llf.png";
const JackCarousel = () => {
  ...
  const slides = [
    {
      ...
      alt: "slide1",
      badge: "welmake",
      title: "2x Stain Removal",
      subtitle: "Discover Your Glow",
      description:
        "Say goodbye to stubborn stains with our advanced formula, delivering twice the cleaning power for a spotless shine.",
    ...
    },
    {
      ...
      description:
        "Enjoy a rich, luxurious lather that deeply cleanses while being gentle on your skin, leaving it fresh and rejuvenated.",
    ...
    },
    {
      ...
      description:
        "Immerse yourself in a captivating scent that lasts all day, keeping you fresh and confident with every use.",
      buttonText: "Shop Now",
      accent: "bg-gradient-to-r from-amber-600/30 to-orange-600/30 backdrop-blur-md",
    }
  ];
