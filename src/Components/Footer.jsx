        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <ul className="font-baloo">
              ...
              <li className="mb-2">
                <a href="/about" className="hover:underline text-xl">About Us</a>
              </li>
              <li className="mb-2">
                <a href="/contact" className="hover:underline text-xl">Contact Us</a>
              </li>
              <li className="mb-2">
                <a href="/career" className="hover:underline text-xl">Career</a>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex gap-4">
              ...
              <li className="mb-2">
                <a href="/gwash" className="hover:underline text-xl">G wash</a>
              </li> <li className="mb-2">
                <a href="/dr7" className="hover:underline text-xl">Dr.7</a>
              </li>
            </div>
          </div>
        </div>
