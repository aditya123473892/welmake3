...
import slide1 from "../../assets/slide1-gwash1.png";
import slide2 from "../../assets/slide2-gwash1.png";
import slide3 from "../../assets/slide3-gwash1.png";
const JackCarousel = () => {
  ...
  const slides = [
    {
      ...
      description:
        "Effortlessly removes tough stains and grime from utensils, ensuring a spotless shine.",
    ...
    },
    {
      ...
      alt: "slide2",
      badge: "welmake",
      title: "Refreshing Lemon Essence",
      subtitle: "Beauty with Purpose",
      description:
        "Infused with a zesty lemon fragrance that enhances cleaning and leaves a fresh scent.",
    ...
    },
    {
      ...
      description:
        "Keeps your kitchen smelling delightful with a fragrance that lingers after every wash.",
      buttonText: "Shop Now",
      accent: "bg-gradient-to-r from-amber-600/30 to-orange-600/30 backdrop-blur-md",
    }
  ];
