...
import { FaWhatsapp as WhatsappIcon, FaStar as Star, FaBox as Package2 } from "react-icons/fa"; // Imported missing icons
import AutocarouselGwash from "../Components/gwash/AutocarouselGwah"; // Fixed import path
import MidSectionGwash from "../Components/gwash/MidSectionGwash";
import gwash from "../assets/g wash.png"; // Renamed file to avoid spaces
            ...
            <div className="flex flex-col md:flex-row gap-8">
              <div className="flex-1">
                ...
                <div className="text-2xl font-bold text-white mb-4">
                  ₹95.00 <span className="text-blue-200 text-lg">/ Per Box</span>
                </div>
                <ul className="text-blue-100 space-y-2 mb-6">
                  <li className="flex items-center gap-2">
                    <Package2 className="w-5 h-5" />
                    <span>Premium quality dish washing liquid</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Package2 className="w-5 h-5" />
